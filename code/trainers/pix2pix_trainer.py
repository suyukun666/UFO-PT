...
class Pix2PixTrainer():
    ...
    def update_fixed_params(self):
        ...
        for param in self.pix2pix_model_on_one_gpu.net['background'].parameters():
            param.requires_grad = True
        ...
        G_params += [{'params': self.pix2pix_model_on_one_gpu.net['background'].parameters(), 'lr': self.opt.lr*0.5}]
