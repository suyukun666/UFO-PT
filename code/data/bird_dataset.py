...
class birdDataset(Pix2pixDataset):
    ...
    def modify_commandline_options(parser, is_train):
        ...
        parser.set_defaults(label_nc=50)
    ...
    def get_paths(self, opt):
        ...
        all_images = sorted(make_dataset(root + '/' + subfolder, recursive=True, read_cache=False, write_cache=False))
        image_paths = []
        label_paths = []
        for p in all_images:
    ...
    def get_ref(self, opt):
        ...
        with open('./data/bird_ref{}.txt'.format(extra)) as fd:
            lines = fd.readlines()
        ref_dict = {}
